const DATA = [
    ...
    { 
      ...
      { name:"Spices", items:[
        { name:"Turmeric", symptoms:"Skin rash, upset stomach", info:"Spice allergies are rare." },
        { name:"Cinnamon", symptoms:"Rash, mouth irritation", info:"Mild oral allergy syndrome." },
        { name:"Clove", symptoms:"Mouth pain, skin rash", info:"Rare, mostly oral symptoms." },
        { name:"Pepper", symptoms:"Sneezing, rash, indigestion", info:"Often mild, includes skin reactions." },
        { name:"Nutmeg", symptoms:"Itching, GI upset", info:"May trigger oral or skin symptoms." },
        { name:"Ginger", symptoms:"Skin rash, nausea", info:"Reported mild reactions." },
        { name:"Cardamom", symptoms:"Rash, nausea", info:"Spice seeds can be allergenic." },
        { name:"Coriander", symptoms:"Stomach pain, mouth itching", info:"Mild oral allergy syndrome." },
        { name:"Cumin", symptoms:"Skin rash, stomach upset", info:"Rare, mild reactions." },
        { name:"Fenugreek", symptoms:"Skin irritation, stomach pain", info:"Limited documented cases." },
        { name:"Saffron", symptoms:"Skin rash, upset stomach", info:"Rare, expensive spice allergy." },
        { name:"Paprika", symptoms:"Rash, itching", info:"Capsaicin may trigger symptoms." },
        { name:"Tamarind", symptoms:"Rash, itching, stomach pain", info:"Mild oral symptoms." },
        { name:"Basil", symptoms:"Skin irritation, rash", info:"Rare, mild symptoms." },
        { name:"Oregano", symptoms:"Stomach pain, rash", info:"Oral allergy syndrome possible." },
        { name:"Thyme", symptoms:"Skin rash, stomach pain", info:"Rare case reports." },
        { name:"Rosemary", symptoms:"Skin irritation, rash", info:"Rare documented allergies." },
        { name:"Marjoram", symptoms:"Stomach pain, rash", info:"Rare, mild symptoms." },
        { name:"Mint", symptoms:"Rash, mouth itching", info:"Oral allergy syndrome documented." },
        { name:"Parsley", symptoms:"Itching, rash, stomach pain", info:"Possible mild symptoms." },
        { name:"Dill", symptoms:"Rash, itching", info:"Rare spice allergy." },
        { name:"Tarragon", symptoms:"Skin rash, mouth irritation", info:"Limited reports." },
        { name:"Sage", symptoms:"Skin rash, nausea", info:"Rare, mild symptoms." },
        { name:"Bay Leaf", symptoms:"Rash, itching", info:"Reported mild reactions." },
        { name:"Wasabi", symptoms:"Rash, burning sensation", info:"Rare, mostly mild symptoms." },
      ]},
      { name:"Legumes", items:[
